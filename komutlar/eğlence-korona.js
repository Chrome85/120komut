...
if (!args.length) {
          ...
          console.log(response)
                ...
                .catch((error) => {
          message.channel.send('<a:carpi:772430970896908298> Hata \n Lütfen ülke girerken global olarak giriniz. Örnek: Turkey veya turkey şeklinde girebilirsiniz.<a:carpi:772430970896908298> ')
                    console.log(error);
                });
        }
}
